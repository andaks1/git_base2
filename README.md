...
#### Ответ не задание 1.
Гитлаб аккаунт завести мне не удалось... Я даже задал вопрос к домашке.
Гитлаб для регистрации просит верификацию email’а и номера телефона. С емайлом все просто, с номером телефона нет. России просто нет в списке. И дальше этого он никуда не пускает. Через авторизацию посредством github проблемы те же.
Поэтому я решил завести новый ак на гитхабе и пушить в него.

Скрин по новому origin'у:
![new_origin](img/zadanie1/01_01.png)

Здесь список добавленных реп:
![origin_list](img/zadanie1/01_02.png)
